...
<ul>
<ul><a href="https://felipeacosta.name/">https://felipeacosta.name/</a></ul>
<ul><a href="https://felipeacosta.name/">https://felipeacosta.name/</a></ul>
</ul>
</body>
</html>
...
<p>
  ...
  string using the <a href="https://felipeacosta.name/contact">Flutter 
  webview</a> plugin.
</p>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Builder(builder: (BuildContext context) {
        return WebView(
          initialUrl: 'https://felipeacosta.name',
          ...
          navigationDelegate: (NavigationRequest request) {
            if (request.url.startsWith('https://felipeacosta.name/')) {
